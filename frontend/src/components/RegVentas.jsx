        ...
        <div className="row">
          <div className="col-12">
            <form id="formulario">
              ...
              <div className="form-group row">
                <label htmlFor="vtVenta" className="col-sm-2 col-form-label">
                  {" "}
                  Valor total venta{" "}
                </label>{" "}
                <div className="col-sm-4">
              ...
              <div className="form-group row">
                <label htmlFor="fVenta" className="col-sm-2 col-form-label">
                  {" "}
                  Fecha venta{" "}
                </label>{" "}
                <div className="col-sm-4">
              ...
              <div className="form-group row">
                <label htmlFor="idCliente" className="col-sm-2 col-form-label">
                  {" "}
              ...
              <div className="form-group row">
                <label htmlFor="nCliente" className="col-sm-2 col-form-label">
                  {" "}
                  Nombre cliente{" "}
                </label>{" "}
                <div className="col-sm-4">
              ...
              <div className="form-group row">
                ...
                <div className="col-sm-4">
                  <input
                    ...
                    value={form.name}
                    ref={refVendedor}
                    placeholder="Vendedor encargado"
                    onChange={handleChange}
                  />{" "}
                </div>{" "}
              </div>{" "}
          ...
          <div className="col-12">
            {" "}
            {/*Tabla*/} <p className="h2"> Ultimas ventas registradas </p>{" "}
            <table className="table table-responsive" id="Table">
              <thead>
                <tr>
                  <th scope="col"> # </th> <th scope="col"> Identificador </th>{" "}
              ...
              <tbody>
                <tr>
                  <th scope="row"> 1 </th> <td> oHOBqxI6b </td> <td> 5 </td>{" "}
                  <td> $35 .000 </td> <td> $175 .000 </td>{" "}
                  <td> 01 / 09 / 2021 </td> <td> 1000256225 </td>{" "}
                  <td> Joaquin Gonzalez </td> <td> Lorena Hernandez </td>{" "}
                </tr>{" "}
                <tr>
